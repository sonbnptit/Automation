...
public class POS {
    ...
    private String lastestShipDate;
    ...
    public String getTestcasejira() {
        return testcasejira;
    }

    public void setTestcasejira(String testcasejira) {
        this.testcasejira = testcasejira;
    }
    ...
    public String getShiptToAddress() {
        return shiptToAddress;
    }

    public void setShiptToAddress(String shiptToAddress) {
        this.shiptToAddress = shiptToAddress;
    }
    ...
    public String getLastestShipDate() {
        return lastestShipDate;
    }

    public void setLastestShipDate(String lastestShipDate) {
