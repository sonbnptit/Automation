...
public class CaseInsensitiveMapObjWrapper<K> extends CaseInsensitiveMap<String, String> {
    ...
    public CaseInsensitiveMapObjWrapper(K dtObject, int initialCapacity) {
        super(initialCapacity);
        setDtObject(dtObject);
    }

    public CaseInsensitiveMapObjWrapper(K dtObject, int initialCapacity, float loadFactor) {
        super(initialCapacity, loadFactor);
        setDtObject(dtObject);
    }

    public CaseInsensitiveMapObjWrapper(K dtObject, Map<? extends String, ? extends String> map) {
        super(map);
        setDtObject(dtObject);
    }

    public CaseInsensitiveMapObjWrapper(K dtObject, Map<? extends String, ? extends String> map, boolean nullable) {
        super(map);
        setDtObject(dtObject, nullable);
    }
